...
Upgrade : 02-2026 Added sleep aggregation to aggregate across all sleep, so naps and long-sleep will be totaled for the day. 

Dev Note. To export the stack.env for dev testing: set -a  && source stack.env &&set +a
